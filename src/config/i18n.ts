...
export const translations: Record<Language, TranslationDictionary> = {
  ko: {
    ...
    toolPdfMergeTitle: 'PDF 합치기 (PDF Merge)',
    toolPdfMergeDesc: '여러 개의 PDF 문서를 원하는 순서대로 배치하여 하나의 깔끔한 PDF 파일로 병합합니다.',
  ...
  es: {
    ...
    dropFileSub: 'Procesado 100% seguro en la memoria de su navegador sin carga al servidor',
    privacyBadge: '🔒 Procesamiento 100% seguro en el navegador',
    brandSub: 'Portal de Utilidades Todo en Uno',
    navTitle: 'Menú de Utilidades',
    heroTitle: 'Rápido y Seguro Gratis',
    heroHighlight: 'Portal de Utilidades Web',
    heroDesc: 'Todas las herramientas funcionan 100% en la memoria de su navegador sin cargar archivos al servidor.',
    featSpeed: '⚡ Alta Velocidad',
    featSecurity: '🔒 100% Privacidad',
    featFree: '💯 100% Gratis',
    pdfCategoryTitle: 'Herramientas PDF',
    imageCategoryTitle: 'Herramientas de Imagen',
    mediaCategoryTitle: 'Video y Audio',
    textCategoryTitle: 'Utilidades de Texto',
  ...
  zh: {
    ...
    dropFileSub: '100% 在您的浏览器内存中安全处理，零服务器上传',
    privacyBadge: '🔒 100% 浏览器内存安全处理',
    brandSub: '多合一 Web 工具门户',
    navTitle: '实用工具菜单',
    heroTitle: '快速安全免费的',
    heroHighlight: 'Web 工具门户',
    heroDesc: '所有工具均在浏览器内存中 100% 安全运行，无需上传文件到服务器。',
    featSpeed: '⚡ 超高速转换',
    featSecurity: '🔒 100% 隐私保护',
    featFree: '💯 永久免费',
    pdfCategoryTitle: 'PDF 工具',
    imageCategoryTitle: '图像工具',
    mediaCategoryTitle: '视频与音频',
    textCategoryTitle: '文本工具',
  ...
  ja: {
    ...
    dropFileSub: 'サーバーアップロードなしで100%ブラウザメモリ内で安全に処理されます',
    privacyBadge: '🔒 100% ブラウザメモリ安全処理',
    brandSub: 'オールインワンユーティリティポータル',
    navTitle: 'ユーティリティメニュー',
    heroTitle: '高速・安全・無料の',
    heroHighlight: 'Webユーティリティポータル',
    heroDesc: 'すべてのツールはファイルをサーバーにアップロードせず、ブラウザメモリ内で100%安全に動作します。',
    featSpeed: '⚡ 超高速変換',
    featSecurity: '🔒 100% プライバシー保護',
    featFree: '💯 永久無料利用',
    pdfCategoryTitle: 'PDFツール',
    imageCategoryTitle: '画像ツール',
    mediaCategoryTitle: '動画＆音声',
    textCategoryTitle: 'テキストユーティリティ',
